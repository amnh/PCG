...
import           Bio.Character.Decoration.Continuous           hiding
                                                                (characterName,
                                                                toContinuousCharacter)
import           Bio.Character.Decoration.Discrete             hiding
                                                                (characterName)
import           Bio.Character.Decoration.Dynamic              hiding
                                                                (characterName)
...
import           Bio.Metadata.CharacterName                    hiding
                                                                (sourceFile)
