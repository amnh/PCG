...
data FitchDecorationInitial f
   ...
   { fitchDecorationInitialCharacter :: d
   , metadata                        :: DiscreteCharacterMetadataDec d
   }


-- | (✔)
instance HasDiscreteCharacter (FitchDecorationInitial f) d where
...
-- | (✔)
instance (EncodableDynamicCharacter f) => DynamicDecoration (FitchDecorationInitial f) f where
