...
type SeqConstraint               s b   = (EncodableDynamicCharacter s, Eq s, CharConstraint b, Show s, Bits s, DynamicCoded s)
type SeqConstraint'              s     = (EncodableDynamicCharacter s, Eq s, Show s, Bits s, Memoizable s, DynamicCoded s)
