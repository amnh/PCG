...
naiveDO seq1 seq2 meta
    ...
    | otherwise = 
        let
            ...
            firstMatRow = firstAlignRow (fst defaultCosts) longer longlen 0 0 
            traversalMat = firstMatRow `joinMat` getAlignRows longer shorter defaultCosts 1 firstMatRow
...
generateRow seq1 seq2 costvals@(indelCost, subCost) rowNum prevRow@(costValues, _, _) (position, prevCost) 
