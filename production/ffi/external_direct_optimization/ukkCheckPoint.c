...
*/
    ...
    if ( currentUkkCell->editDist > furthestReached_global
       ) {
        furthestReached_global = currentUkkCell->editDist;
    }
           ...
           )
{
    ...
    editDist = Ukk( lessMidd_idx_diff
                  , lessLong_idx_diff
                  , input_editDist - 1
                  , toState
                  , affineCosts
