...
/****************  Allocate sequences  ****************/
    ...
    seq_p longSeq   = initializeSeq(total_poss_align_len, firstSeq,  firstSeqLen);
    seq_p shortSeq  = initializeSeq(total_poss_align_len, secondSeq, secondSeqLen);
    seq_p mediumSeq = initializeSeq(total_poss_align_len, thirdSeq,  thirdSeqLen);
...
/**************************************************** Do 2d alignment ********************************************************/
    ...
    if (DO_2D) {
        ...
        seq_p algnSeq = initializeSeq(total_poss_align_len, algnSeqVals, retLongSeq->len);
        free (algnSeqVals);
