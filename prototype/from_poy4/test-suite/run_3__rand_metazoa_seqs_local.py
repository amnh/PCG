...
def main():
    ...
    filepath = "/Users/eric/Dropbox-AMNH/First_real_data/test_files/"

    filename = filepath + "2metazoa18s-short.fasta"

    wcOutput = ''.join( map(chr, check_output(['wc', '-l', filename])) ).split()[0]
    ...
    ##### Now start ffi call
        ...
        print("Run number", run, end - start) # total time the C code ran
