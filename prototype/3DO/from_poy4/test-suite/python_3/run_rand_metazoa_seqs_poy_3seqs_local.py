...
def main():
    ...
    #     poy_file_2d = open( "infile_2d_processor_{}_run_{}.poy".format(whichProcessor, runNum), "w" )
    #     poy_file_3d = open( "infile_3d_processor_{}_run_{}.poy".format(whichProcessor, runNum), "w" )
