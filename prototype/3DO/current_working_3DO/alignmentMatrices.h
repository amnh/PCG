...
typedef struct alignment_matrices_t {
    ...
    unsigned int    *algn_costMtx3d;   /** Matrix for 3d alignment, just a set of pointers into algn_costMtx
                                        *  --- alloced internally.
                                        */
    DIR_MTX_ARROW_t *algn_dirMtx3d;    /** Matrix for backtrace directions in a 3d alignment, just a set of pointers into algn_costMtx
                                        *  --- alloced internally
                                        */
