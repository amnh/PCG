...
algn3d :: ( EncodableDynamicCharacter s
       ...
       -> (Word, s, s, s, s, s)     -- ^ The cost of the alignment
                                    --
                                    --   The /ungapped/ median derived from the the input characters' N-W-esque matrix traceback
                                    --
                                    --   The /gapped/ median derived from the the input characters' N-W-esque matrix traceback
                                    --
                                    --   The alignment of the /first/ input character when aligned with the second & third character
                                    --
                                    --   The alignment of the /second/ input character when aligned with the first & third character
                                    --
                                    --   The alignment of the /third/ input character when aligned with the first & second character
                                    --
algn3d char1 char2 char3 mismatchCost openingGapCost indelCost denseTCMs = handleMissingCharacterThreeway someFun char1 char2 char3 $
...
--                !_ <- trace ("char 2: " <> show char2) $ pure ()
                ...
                let !cost = align3dFn_c char1ToSend char2ToSend char3ToSend
                                        ...
                                        retUngapped retGapped
                                        costStruct
                                        (coerceEnum mismatchCost)
                                        (coerceEnum openingGapCost)
