...
parmap strat f = withStrategy rpar . fmap f
...
parZipWith strat f lhs rhs = withStrategy rpar $ zipWith f lhs rhs
...
parZipWith3 strat f x y z = withStrategy rpar $ zap (zipWith f x y) z
