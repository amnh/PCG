...
int wrapperFunction( elem_t *input_vals1
                   ...
                   // , elem_t *output_vals2
                   // , elem_t *output_vals3
                   // , elem_t *gappedMedian_out
                   // , elem_t *ungappedMedian_out
                   )
{
...
/************************************************ Do 3d alignment *************************************************/
    ...
    /* I started to do this to send the three outputs back to Python for eventual comparison to the POY output. But then I realized
       that POY would be comparing three different sequences anyway, because it needs an entire tree as input. And I'm too lazy to work
       around that, since eventually the 3D traversal will be done and I can just do the comparison then.
    output_vals1 = realloc( output_vals1,  ) */
    printf( "alphSize: %zu\n", alphSize );
    printf( "gap char: %u\n",  gap_char );
...
int wrapperFunction_copyOnly( elem_t *input_vals1
                            , size_t  lenChar1
                            , elem_t *input_vals2
                            , size_t  lenChar2
                            , elem_t *input_vals3
