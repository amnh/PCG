...
\subsection{Postorder scoring characters}

All characters are scored an have their preliminary assignments derived from a post-order traversal over the graph components.
 
\subsection{Rerooting non-exact characters}
